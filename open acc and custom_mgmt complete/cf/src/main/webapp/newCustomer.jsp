...
out.println("<tr><td>DOB</td><td><input type=text id=name name=dob required placeholder=dd-mm-yy><br></td></tr><tr><td>Primary Phone</td><td><input type=text id=p_ph name=p_ph onBlur=phoneExtr() required ><br></td></tr>");
