...
out.println("<div class="box"><form id=x><h1 align=center tabindex=1>New Customer Registration</h1><table border=0 width=580px cellpadding=10 cellspacing=0 align=center tabindex=1 ><tr><td class="txt">Customer Name</td><td><input type=text id=name name=name required><br></td></tr><tr><td class="txt">Address</td><td><textarea id=address name=address rows=5 cols=20 required></textarea><br></td></tr><tr><td class="txt">PAN Number</td><td ><input type=text id=name name=pan required ><br></td><!-- <td><input type=text id=name name=pan required pattern=[A-Z]{5}[0-9]{4}[A-Z]{1}><br></td> --></tr>");
out.println("<tr><td class="txt">DOB</td><td><input type=text id=name name=dob required placeholder=dd-mm-yy><br></td></tr><tr><td class="txt">Primary Phone</td><td><input type=text id=p_ph name=p_ph onBlur=phoneExtr() required ><br></td></tr>");
out.println("<tr><td class="txt">Primary Email</td><td><input type=text id=p_email name=p_email required><br></td></tr><tr><td class="txt">Alternate Phone</td><td><input type=text id=a_ph name=a_ph ><br></td><!-- <td><input type=text id=a_ph name=a_ph><br></td> --></tr><tr><td class="txt">Alternate Email</td><td><input type=text id=a_email name=a_email><br></td></tr></table></form>");
%>
